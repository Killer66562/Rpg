                        ...
                        if atkinfo.defender.is_dead:
                            ...
                            if isinstance(atkinfo.defender, player.Player):
                                ...
                                if self.all_player_dead:
                                    return game_info.GameInfo(gained_money=0, gained_exp=0, success=False)
                if stage.clear:
                    break
        return game_info.GameInfo(gained_money=gained_money, gained_exp=gained_exp, success=True)
