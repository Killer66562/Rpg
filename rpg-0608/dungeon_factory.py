...
class DungeonFactory(object):
    ...
    def generate(self, dungeon_type:str, dungeon_id:str) -> dungeon.Dungeon:
        with open(file=f"./rpg/data/dungeons/{dungeon_type}/{dungeon_id}.json", mode='r', encoding='utf8') as file:
